...
// Main schema for Customer Growth KPIs
const CustomerGrowthKPISchema = new mongoose.Schema({
...
module.exports = mongoose.model('CustomerGrowthKPI', CustomerGrowthKPISchema);